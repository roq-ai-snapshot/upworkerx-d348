...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'freelancer.create': {
    ...
    key: 'freelancer-profile-created',
    tenantPath: ['company', 'project', 'booking', 'freelancer'],
    userPath: [],
  },
  'freelancer.update': {
    roles: ['business-owner'],
    key: 'freelancer-profile-updated',
    tenantPath: ['company', 'project', 'booking', 'freelancer'],
    userPath: [],
  },
  'booking.create': {
    ...
    tenantPath: ['company', 'project', 'booking'],
    userPath: [],
  },
  'booking.delete': {
    roles: ['business-owner'],
    key: 'freelancer-booking-deleted',
    tenantPath: ['company', 'project', 'booking'],
    userPath: [],
  },
  'freelancer.delete': {
    roles: ['business-owner'],
    key: 'freelancer-profile-deleted',
    tenantPath: ['company', 'project', 'booking', 'freelancer'],
    userPath: [],
  },
};
